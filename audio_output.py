...
def generate_audio_response(text: str, output_file_path: str = "/sui_app_audio_dirs/audio_output/speech.mp3") -> None:
    """
...
def play_sound(sound_path: str = "/sui_app_audio_dirs/audio_output/speech.mp3") -> None:
    """
